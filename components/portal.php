    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="nav-item">
            <button class="nav-link active" role="tab"
                ...
                aria-controls="register" aria-selected="true"><?= $MSG['register']; ?></button>
        </li>
        <li role="presentation" class="nav-item">
            <button class="nav-link" role="tab"
                data-bs-toggle="tab" data-bs-target="#login"
                aria-controls="login" aria-selected="false"><?= $MSG['login']; ?></button>
        </li>
    </ul>
